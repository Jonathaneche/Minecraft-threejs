...
export class Physics {
     ...
     * of the blocks the player is actually colliding with
    ...
    narrowPhase(candidates, player) {
        ...
        for (const block of candidates) {
            ...
            // 2. Determinate if point is inside player's bounding cylinder
            ...
            if (this.pointInPlayerBoundingCylinder(closestPoint, player)) {
                ...
                // cylinder along the y-axis and the xz-plane
    ...
    /**
     * Resolves each of the collisions found in the norrow-phase
     * @param {*} collisions 
     * @param {Player} player 
     */
    resolveCollitions(collisions, player) {
        ...
        for (const collision of collisions){
            ...
            // Get the magnitu of the player's velocity along the collision normal
            let magnitude = player.worldVelocity.dot(collision.normal);
            // Remove that part of the velocity from the plaer's velocity
    ...
    /**
     * Return thue if the point 'p' is inside the player's bounding cylinder
